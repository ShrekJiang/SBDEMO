...
public class OSUtils {
                ...
                if (line.startsWith("  eth")) {
                    ...
                    while (tokenizer.hasMoreElements()) {
                        ...
                        if (value.contains(":")) {
                            ...
                            map.put("byteReceive", value.split(":")[1]);
                            int i = 0;
                            while (i < 8) {
                                i++;
    ...
    public static List<String> jvmInfo() {
        ...
        result.add("jvm.name (JVM名称-版本号-供应商):" + runtime.getVmName() + " | version: " + runtime.getVmVersion() + " | vendor: " + runtime.getVmVendor() + ";");
        result.add("jvm.spec.name (JVM规范名称-版本号-供应商):" + runtime.getSpecName() + " | version: " + runtime.getSpecVersion() + " | vendor: " + runtime.getSpecVendor() + ";");
